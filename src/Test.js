...
// import ShowListAlertScreen from "./AlerteScreen/ShowListAlerteScreen";
...
class Test extends Component {
    ...
    // componentDidMount() {
    //     console.log("ShareParticularAlerteScreen did mount")

    //     /** fonctions de verification de donnée mobile et d'etat de l'app */
    ...
    //         console.log('Home App has come to the foreground!', this.state.appState);
    //     }
    //     if (this.state.appState === 'active' && nextAppState.match(/inactive|background/)) {
    //         this.componentWillUnmount();
    //         console.log('Home App will go to the background!', this.state.appState);
    //     }
